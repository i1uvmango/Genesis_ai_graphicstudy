...
![car_overview](../res_wjdaksry/1015/car_body.png)
...
![주행 테스트](../res_wjdaksry/1014/car_test_drive.gif)

---

## 배경
- Blender에서 차량 모델링
  - 참고: [모델링 비디오(mp4)](../res_wjdaksry/car_modeling.mp4)
...
- 모델/리소스 폴더: [`res_wjdaksry/`](res_wjdaksry/)
- Blender 파일: [`res_wjdaksry/car.blend`](res_wjdaksry/car.blend)
- 바퀴 관련 파일들: [`res_wjdaksry/*wheel*`](res_wjdaksry/)
- 모델링 비디오: [`res_wjdaksry/car_modeling.mp4`](res_wjdaksry/car_modeling.mp4)
- 테스트 주행 GIF: [`res_wjdaksry/1014/car_test_drive.gif`](res_wjdaksry/1014/car_test_drive.gif)
- 참조 이미지: [`res_wjdaksry/1014/car_img.png`](res_wjdaksry/1014/car_img.png)
