# Blender Car Rigging
 ...
 ![rig_name](../res_wjdaksry/1021/rig_name.png)  
![car2](../res_wjdaksry/1021/blender_car2.png)
...
### 1. 개요
바퀴  구조에는  
* `Car-Wheel.Ft.L` 과 `MCH-Wheel.rotation.Ft.L` Bone 존재
...
결론: MCH__ 가 아닌 **휠/차체**(car_/ctrl_) 본체를 제어    
  ![](../res_wjdaksry/1021/car_rigid.png)
...
## Blender Animation
![](../res_wjdaksry/1021/blender_animation.gif)
* 실제 물리법칙이 아닌 애니메이션
