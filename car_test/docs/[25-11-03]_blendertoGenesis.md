...
![export_setting](../res_wjdaksry/1103/export_setting.png)
...
```
### 적용 결과
![error](../res_wjdaksry/1103/blender_car_error.png)
...
#### 추출 데이터
![data_extracting](../res_wjdaksry/1103/data_extracting.gif)
```
...
### parameter
![params](../res_wjdaksry/1103/params.png)
* data.csv : 89kb (매우 작음)
