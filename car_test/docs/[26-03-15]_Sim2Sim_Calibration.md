...
2. [문제 정의: 왜 Blender의 T,S 전달만으로는 부족한가](#2-문제-정의-왜-ts-전달만으로는-부족한가)
...
|---|---|---|
| **동일 (T,S) 입력 시** | ![stage1](../res_wjdaksry/0216/stage1.png) | ![stage2](../res_wjdaksry/0216/stage2_2.png) |
...
### Blender 의 Kinematics 움직임

![](../res_wjdaksry/0316/box.png)

![](../res_wjdaksry/0316/ukmac.gif)

* 충돌 객체의 무게를 100,000kg 으로 설정 후 충돌 테스트 실행
* 충돌 후 지면에 닿을때 기존 속도로 바로 돌아가는 Kinematics 스러운 움직임
...
- Bullet Engine 과 비슷하지만, **GPU optimization**,**NN Friendly** 한 구조로 
...
|---|---|---|
| ![blender_car](../res_wjdaksry/0316/blender_car.gif) | ![car_img](../res_wjdaksry/1014/car_img.png) | ![car_final](../res_wjdaksry/0316/car.png) |
...
매 Frame t 마다:
  ...
  ⑥ t+1로 이동: t-step의 golden(T,S)에서 warm-start 탐색
```
...
|---|---|---|
| [![blender](../res_wjdaksry/0316/blender.png)](https://github.com/user-attachments/assets/94549c51-5cd4-41d1-a187-f1262d5e1e53) | [![mppi](../res_wjdaksry/0222/path_new2.png)](https://github.com/user-attachments/assets/14f37b64-8207-4769-9267-a65f0ed32e82) | [![mlp](../res_wjdaksry/0222/curve1.png)](https://github.com/user-attachments/assets/e031fadc-0774-46c6-a9dc-267cfccdd9be) |
* 이미지 클릭 시 영상 재생

MLP는 MPPI의 주행 품질을 실시간으로 재현하였다.


* 주행 영상 정리 : [inference result](https://github.com/i1uvmango/Genesis_ai_graphicstudy/blob/main/car_test/docs/%5B26-03-05%5D_BC_inverse_mappper.md)
...
- [추론/주행 영상 정리](https://github.com/i1uvmango/Genesis_ai_graphicstudy/blob/main/car_test/docs/%5B26-03-05%5D_BC_inverse_mappper.md)
