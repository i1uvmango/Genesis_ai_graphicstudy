...
* MPPI 의 설계와 동일하게 미래 10프레임의 `(vel, kappa)`을 주어 미래 정보 고려한 제어를 할 수 있도록 함
...
docs for details : [BC Inverse Mapper](https://github.com/i1uvmango/Genesis_ai_graphicstudy/blob/main/car_test/docs/%5B26-03-05%5D_BC_inverse_mappper.md)