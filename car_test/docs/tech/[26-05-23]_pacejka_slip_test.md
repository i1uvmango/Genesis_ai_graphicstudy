...
**측정**: 브레이크 구간 동안 누적 slip distance, v_lat 고점, bang-bang(roll osciliation).


#### arc length (m) — 실제 누적 이동 거리 ★ (`|Δy|` 적분)

> 진동 + drift 모두 포함한 **진짜 슬립 양**. 항상 양수.

| θ \ hold_k_lat | 0 (baseline) | **5K** | **10K** | 50K | 100K | 200K |
|---:|---:|---:|---:|---:|---:|---:|
| 5° | 0.132 | **0.092** | 0.108 | 0.264 | 0.203 | 0.188 |
| 10° | 0.227 | **0.095** | 0.115 | 0.245 | 0.229 | 0.304 |
| 15° | 0.210 | 0.060 | **0.040 ★** | 0.264 | 0.283 | 0.228 |
| 20° | 0.188 | 0.116 | **0.091** | 0.248 | 0.242 | 0.236 |

#### max excursion (m) — brake 시작점 대비 최대 이탈 

| θ \ hold_k_lat | 0 | **5K** | **10K** | 50K | 100K | 200K |
|---:|---:|---:|---:|---:|---:|---:|
| 5° | 0.098 | **0.092** | 0.108 | 0.261 | 0.193 | 0.157 |
| 10° | 0.100 | **0.062** | 0.102 | 0.082 | 0.085 | 0.151 |
| 15° | 0.185 | 0.053 | **0.022 ★** | 0.253 | 0.278 | 0.181 |
| 20° | 0.077 | **0.057** | 0.068 | 0.176 | 0.165 | 0.064 |
...
→ 두 시나리오 모두 동일 결론. 권장값 **5K ~ 10K** 는 시나리오 robust. (bangbang : overcorrection oscilation)
